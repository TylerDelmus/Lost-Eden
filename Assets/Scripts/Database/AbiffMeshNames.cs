...
/// <summary>
/// Resolves abiff mesh file names to RDB ids via InfoObject(1) / ResourceTypeId.RdbMesh.
/// Shared: the playfield tweaks, the effect models and LoginWorld all address meshes by name.
/// </summary>
public sealed class AbiffMeshNames
{
    readonly Dictionary<string, int> _nameToId =
        new Dictionary<string, int>(StringComparer.OrdinalIgnoreCase);

    public AbiffMeshNames(ResourceDatabase database)
    {
